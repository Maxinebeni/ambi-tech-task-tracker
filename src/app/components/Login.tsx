      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#0D1B3E] focus:border-transparent transition-all"
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-[#0D1B3E] text-white py-3 px-4 rounded-lg hover:bg-[#1a2d5f] transition-colors disabled:opacity-60"
            >
          ...
          <button
            ...
            disabled={submitting}
            className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg py-3 px-4 hover:bg-gray-50 transition-colors disabled:opacity-60"
          >
            <GoogleIcon />
